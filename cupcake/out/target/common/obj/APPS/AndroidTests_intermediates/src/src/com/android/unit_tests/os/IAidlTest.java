 ...
 * Original file: frameworks/base/tests/AndroidTests/src/com/android/unit_tests/os/IAidlTest.aidl
 */
...
public static abstract class Stub extends android.os.Binder implements com.android.unit_tests.os.IAidlTest
{
private static final java.lang.String DESCRIPTOR = "com.android.unit_tests.os.IAidlTest";
...
/**
 * Cast an IBinder object into an IAidlTest interface,
 * generating a proxy if needed.
 */
public static com.android.unit_tests.os.IAidlTest asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = (android.os.IInterface)obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.android.unit_tests.os.IAidlTest))) {
return ((com.android.unit_tests.os.IAidlTest)iin);
}
return new com.android.unit_tests.os.IAidlTest.Stub.Proxy(obj);
}
...
{
data.enforceInterface(DESCRIPTOR);
com.android.unit_tests.os.AidlTest.TestParcelable _arg0;
if ((0!=data.readInt())) {
_arg0 = com.android.unit_tests.os.AidlTest.TestParcelable.CREATOR.createFromParcel(data);
}
else {
_arg0 = null;
}
com.android.unit_tests.os.AidlTest.TestParcelable _result = this.parcelableIn(_arg0);
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
...
data.enforceInterface(DESCRIPTOR);
com.android.unit_tests.os.AidlTest.TestParcelable _arg0;
_arg0 = new com.android.unit_tests.os.AidlTest.TestParcelable();
com.android.unit_tests.os.AidlTest.TestParcelable _result = this.parcelableOut(_arg0);
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
_result.writeToParcel(reply, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
...
com.android.unit_tests.os.AidlTest.TestParcelable _result = this.parcelableInOut(_arg0);
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
_result.writeToParcel(reply, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
...
{
data.enforceInterface(DESCRIPTOR);
java.util.List<com.android.unit_tests.os.AidlTest.TestParcelable> _arg0;
_arg0 = data.createTypedArrayList(com.android.unit_tests.os.AidlTest.TestParcelable.CREATOR);
int _arg1;
_arg1 = data.readInt();
com.android.unit_tests.os.AidlTest.TestParcelable _result = this.listParcelableLonger(_arg0, _arg1);
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
_result.writeToParcel(reply, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
...
data.enforceInterface(DESCRIPTOR);
com.android.unit_tests.os.AidlTest.TestParcelable[] _arg0;
_arg0 = data.createTypedArray(com.android.unit_tests.os.AidlTest.TestParcelable.CREATOR);
com.android.unit_tests.os.AidlTest.TestParcelable[] _arg1;
int _arg1_length = data.readInt();
if ((_arg1_length<0)) {
_arg1 = null;
}
else {
_arg1 = new com.android.unit_tests.os.AidlTest.TestParcelable[_arg1_length];
}
com.android.unit_tests.os.AidlTest.TestParcelable[] _arg2;
_arg2 = data.createTypedArray(com.android.unit_tests.os.AidlTest.TestParcelable.CREATOR);
com.android.unit_tests.os.AidlTest.TestParcelable[] _result = this.parcelableArray(_arg0, _arg1, _arg2);
reply.writeNoException();
...
private static class Proxy implements com.android.unit_tests.os.IAidlTest
{
...
public com.android.unit_tests.os.AidlTest.TestParcelable parcelableIn(com.android.unit_tests.os.AidlTest.TestParcelable p) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.android.unit_tests.os.AidlTest.TestParcelable _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
if ((p!=null)) {
_data.writeInt(1);
...
_reply.readException();
if ((0!=_reply.readInt())) {
_result = com.android.unit_tests.os.AidlTest.TestParcelable.CREATOR.createFromParcel(_reply);
}
else {
_result = null;
}
...
public com.android.unit_tests.os.AidlTest.TestParcelable parcelableOut(com.android.unit_tests.os.AidlTest.TestParcelable p) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.android.unit_tests.os.AidlTest.TestParcelable _result;
...
public com.android.unit_tests.os.AidlTest.TestParcelable parcelableInOut(com.android.unit_tests.os.AidlTest.TestParcelable p) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.android.unit_tests.os.AidlTest.TestParcelable _result;
...
public com.android.unit_tests.os.AidlTest.TestParcelable listParcelableLonger(java.util.List<com.android.unit_tests.os.AidlTest.TestParcelable> list, int index) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.android.unit_tests.os.AidlTest.TestParcelable _result;
...
_reply.readTypedList(list, com.android.unit_tests.os.AidlTest.TestParcelable.CREATOR);
}
finally {
_reply.recycle();
_data.recycle();
...
public int listParcelableShorter(java.util.List<com.android.unit_tests.os.AidlTest.TestParcelable> list, int index) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
public com.android.unit_tests.os.AidlTest.TestParcelable[] parcelableArray(com.android.unit_tests.os.AidlTest.TestParcelable[] a0, com.android.unit_tests.os.AidlTest.TestParcelable[] a1, com.android.unit_tests.os.AidlTest.TestParcelable[] a2) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.android.unit_tests.os.AidlTest.TestParcelable[] _result;
...
_reply.readException();
_result = _reply.createTypedArray(com.android.unit_tests.os.AidlTest.TestParcelable.CREATOR);
_reply.readTypedArray(a1, com.android.unit_tests.os.AidlTest.TestParcelable.CREATOR);
_reply.readTypedArray(a2, com.android.unit_tests.os.AidlTest.TestParcelable.CREATOR);
}
finally {
_reply.recycle();
_data.recycle();
...
static final int TRANSACTION_intMethod = (IBinder.FIRST_CALL_TRANSACTION + 0);
static final int TRANSACTION_parcelableIn = (IBinder.FIRST_CALL_TRANSACTION + 1);
static final int TRANSACTION_parcelableOut = (IBinder.FIRST_CALL_TRANSACTION + 2);
static final int TRANSACTION_parcelableInOut = (IBinder.FIRST_CALL_TRANSACTION + 3);
static final int TRANSACTION_listParcelableLonger = (IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_listParcelableShorter = (IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_booleanArray = (IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_charArray = (IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_intArray = (IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_longArray = (IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_floatArray = (IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_doubleArray = (IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_stringArray = (IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_parcelableArray = (IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_voidSecurityException = (IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_intSecurityException = (IBinder.FIRST_CALL_TRANSACTION + 15);
}
public int intMethod(int a) throws android.os.RemoteException;
public com.android.unit_tests.os.AidlTest.TestParcelable parcelableIn(com.android.unit_tests.os.AidlTest.TestParcelable p) throws android.os.RemoteException;
public com.android.unit_tests.os.AidlTest.TestParcelable parcelableOut(com.android.unit_tests.os.AidlTest.TestParcelable p) throws android.os.RemoteException;
