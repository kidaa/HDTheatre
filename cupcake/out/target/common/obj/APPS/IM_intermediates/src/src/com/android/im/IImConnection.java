 ...
 * Original file: packages/apps/IM/src/com/android/im/IImConnection.aidl
 */
...
public static abstract class Stub extends android.os.Binder implements com.android.im.IImConnection
{
private static final java.lang.String DESCRIPTOR = "com.android.im.IImConnection";
 ...
 */
public static com.android.im.IImConnection asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = (android.os.IInterface)obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.android.im.IImConnection))) {
return ((com.android.im.IImConnection)iin);
}
return new com.android.im.IImConnection.Stub.Proxy(obj);
}
...
com.android.im.IConnectionListener _arg0;
_arg0 = com.android.im.IConnectionListener.Stub.asInterface(data.readStrongBinder());
...
{
data.enforceInterface(DESCRIPTOR);
com.android.im.IInvitationListener _arg0;
_arg0 = com.android.im.IInvitationListener.Stub.asInterface(data.readStrongBinder());
...
{
data.enforceInterface(DESCRIPTOR);
com.android.im.IContactListManager _result = this.getContactListManager();
reply.writeNoException();
...
{
data.enforceInterface(DESCRIPTOR);
com.android.im.IChatSessionManager _result = this.getChatSessionManager();
reply.writeNoException();
reply.writeStrongBinder((((_result!=null))?(_result.asBinder()):(null)));
return true;
}
...
{
data.enforceInterface(DESCRIPTOR);
com.android.im.engine.Presence _result = this.getUserPresence();
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
...
{
data.enforceInterface(DESCRIPTOR);
com.android.im.engine.Presence _arg0;
if ((0!=data.readInt())) {
_arg0 = com.android.im.engine.Presence.CREATOR.createFromParcel(data);
}
else {
_arg0 = null;
}
...
private static class Proxy implements com.android.im.IImConnection
{
...
public void registerConnectionListener(com.android.im.IConnectionListener listener) throws android.os.RemoteException
{
...
public void unregisterConnectionListener(com.android.im.IConnectionListener listener) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
public void setInvitationListener(com.android.im.IInvitationListener listener) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
public com.android.im.IContactListManager getContactListManager() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.android.im.IContactListManager _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getContactListManager, _data, _reply, 0);
_reply.readException();
_result = com.android.im.IContactListManager.Stub.asInterface(_reply.readStrongBinder());
}
finally {
_reply.recycle();
_data.recycle();
...
public com.android.im.IChatSessionManager getChatSessionManager() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.android.im.IChatSessionManager _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getChatSessionManager, _data, _reply, 0);
_reply.readException();
_result = com.android.im.IChatSessionManager.Stub.asInterface(_reply.readStrongBinder());
}
finally {
_reply.recycle();
_data.recycle();
...
/**
     ...
     */
public void login(long accountId, java.lang.String userName, java.lang.String password, boolean autoLoadContacts) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
public com.android.im.engine.Presence getUserPresence() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.android.im.engine.Presence _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getUserPresence, _data, _reply, 0);
_reply.readException();
if ((0!=_reply.readInt())) {
_result = com.android.im.engine.Presence.CREATOR.createFromParcel(_reply);
}
else {
_result = null;
}
...
public int updateUserPresence(com.android.im.engine.Presence newPresence) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
