 ...
 * Original file: packages/apps/IM/src/com/android/im/IRemoteImService.aidl
 */
...
public static abstract class Stub extends android.os.Binder implements com.android.im.IRemoteImService
{
private static final java.lang.String DESCRIPTOR = "com.android.im.IRemoteImService";
 ...
 */
public static com.android.im.IRemoteImService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = (android.os.IInterface)obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.android.im.IRemoteImService))) {
return ((com.android.im.IRemoteImService)iin);
}
return new com.android.im.IRemoteImService.Stub.Proxy(obj);
}
...
{
data.enforceInterface(DESCRIPTOR);
com.android.im.IConnectionCreationListener _arg0;
_arg0 = com.android.im.IConnectionCreationListener.Stub.asInterface(data.readStrongBinder());
...
long _arg0;
_arg0 = data.readLong();
com.android.im.IImConnection _result = this.createConnection(_arg0);
reply.writeNoException();
...
private static class Proxy implements com.android.im.IRemoteImService
{
...
/**
     ...
     */
public void addConnectionCreatedListener(com.android.im.IConnectionCreationListener listener) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/**
     ...
     */
public void removeConnectionCreatedListener(com.android.im.IConnectionCreationListener listener) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/**
     ...
     */
public com.android.im.IImConnection createConnection(long providerId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.android.im.IImConnection _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeLong(providerId);
mRemote.transact(Stub.TRANSACTION_createConnection, _data, _reply, 0);
_reply.readException();
_result = com.android.im.IImConnection.Stub.asInterface(_reply.readStrongBinder());
}
finally {
_reply.recycle();
_data.recycle();
