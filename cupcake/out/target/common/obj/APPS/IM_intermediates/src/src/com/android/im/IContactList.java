 ...
 * Original file: packages/apps/IM/src/com/android/im/IContactList.aidl
 */
...
public static abstract class Stub extends android.os.Binder implements com.android.im.IContactList
{
private static final java.lang.String DESCRIPTOR = "com.android.im.IContactList";
...
/**
 * Cast an IBinder object into an IContactList interface,
 * generating a proxy if needed.
 */
public static com.android.im.IContactList asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = (android.os.IInterface)obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.android.im.IContactList))) {
return ((com.android.im.IContactList)iin);
}
return new com.android.im.IContactList.Stub.Proxy(obj);
}
...
private static class Proxy implements com.android.im.IContactList
{
...
static final int TRANSACTION_addContact = (IBinder.FIRST_CALL_TRANSACTION + 2);
static final int TRANSACTION_removeContact = (IBinder.FIRST_CALL_TRANSACTION + 3);
static final int TRANSACTION_setDefault = (IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_isDefault = (IBinder.FIRST_CALL_TRANSACTION + 5);
}
/**
     * Gets the name of the list.
     */
