 ...
 * Original file: packages/apps/IM/src/com/android/im/IContactListManager.aidl
 */
...
public static abstract class Stub extends android.os.Binder implements com.android.im.IContactListManager
{
private static final java.lang.String DESCRIPTOR = "com.android.im.IContactListManager";
 ...
 */
public static com.android.im.IContactListManager asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = (android.os.IInterface)obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.android.im.IContactListManager))) {
return ((com.android.im.IContactListManager)iin);
}
return new com.android.im.IContactListManager.Stub.Proxy(obj);
}
...
com.android.im.IContactListListener _arg0;
_arg0 = com.android.im.IContactListListener.Stub.asInterface(data.readStrongBinder());
...
{
data.enforceInterface(DESCRIPTOR);
com.android.im.ISubscriptionListener _arg0;
_arg0 = com.android.im.ISubscriptionListener.Stub.asInterface(data.readStrongBinder());
...
com.android.im.IContactList _result = this.getContactList(_arg0);
reply.writeNoException();
...
java.lang.String _arg0;
_arg0 = data.readString();
java.util.List<com.android.im.engine.Contact> _arg1;
_arg1 = data.createTypedArrayList(com.android.im.engine.Contact.CREATOR);
...
private static class Proxy implements com.android.im.IContactListManager
{
...
public void registerContactListListener(com.android.im.IContactListListener listener) throws android.os.RemoteException
{
...
public void unregisterContactListListener(com.android.im.IContactListListener listener) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
public void registerSubscriptionListener(com.android.im.ISubscriptionListener listener) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
public void unregisterSubscriptionListener(com.android.im.ISubscriptionListener listener) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/**
     ...
     */
public com.android.im.IContactList getContactList(java.lang.String name) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.android.im.IContactList _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeString(name);
mRemote.transact(Stub.TRANSACTION_getContactList, _data, _reply, 0);
_reply.readException();
_result = com.android.im.IContactList.Stub.asInterface(_reply.readStrongBinder());
}
finally {
_reply.recycle();
_data.recycle();
...
/**
     ...
     */
public int createContactList(java.lang.String name, java.util.List<com.android.im.engine.Contact> contacts) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
