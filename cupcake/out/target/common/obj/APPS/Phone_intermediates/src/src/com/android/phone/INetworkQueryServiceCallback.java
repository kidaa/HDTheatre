 ...
 * Original file: packages/apps/Phone/src/com/android/phone/INetworkQueryServiceCallback.aidl
 */
...
/**
 * Cast an IBinder object into an INetworkQueryServiceCallback interface,
...
java.util.List<com.android.internal.telephony.gsm.NetworkInfo> _arg0;
_arg0 = data.createTypedArrayList(com.android.internal.telephony.gsm.NetworkInfo.CREATOR);
int _arg1;
_arg1 = data.readInt();
...
/**
     ...
     */
public void onQueryComplete(java.util.List<com.android.internal.telephony.gsm.NetworkInfo> networkInfoArray, int status) throws android.os.RemoteException
{
...
mRemote.transact(Stub.TRANSACTION_onQueryComplete, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
static final int TRANSACTION_onQueryComplete = (IBinder.FIRST_CALL_TRANSACTION + 0);
}
/**
     * Called upon query completion, handing a status value and an
     * array of NetworkInfo objects.
