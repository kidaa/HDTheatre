...
static final int TRANSACTION_getMassStorageEnabled = (IBinder.FIRST_CALL_TRANSACTION + 0);
static final int TRANSACTION_setMassStorageEnabled = (IBinder.FIRST_CALL_TRANSACTION + 1);
static final int TRANSACTION_getMassStorageConnected = (IBinder.FIRST_CALL_TRANSACTION + 2);
static final int TRANSACTION_mountMedia = (IBinder.FIRST_CALL_TRANSACTION + 3);
static final int TRANSACTION_unmountMedia = (IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_formatMedia = (IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_getPlayNotificationSounds = (IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_setPlayNotificationSounds = (IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_getAutoStartUms = (IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_setAutoStartUms = (IBinder.FIRST_CALL_TRANSACTION + 9);
}
/**
     * Is mass storage support enabled?
     */
