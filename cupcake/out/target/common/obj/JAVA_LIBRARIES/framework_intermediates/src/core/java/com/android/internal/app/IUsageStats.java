...
/**
 * Cast an IBinder object into an IUsageStats interface,
...
static final int TRANSACTION_noteResumeComponent = (IBinder.FIRST_CALL_TRANSACTION + 0);
static final int TRANSACTION_notePauseComponent = (IBinder.FIRST_CALL_TRANSACTION + 1);
static final int TRANSACTION_getPkgUsageStats = (IBinder.FIRST_CALL_TRANSACTION + 2);
static final int TRANSACTION_getAllPkgUsageStats = (IBinder.FIRST_CALL_TRANSACTION + 3);
}
public void noteResumeComponent(android.content.ComponentName componentName) throws android.os.RemoteException;
public void notePauseComponent(android.content.ComponentName componentName) throws android.os.RemoteException;
public com.android.internal.os.PkgUsageStats getPkgUsageStats(android.content.ComponentName componentName) throws android.os.RemoteException;
