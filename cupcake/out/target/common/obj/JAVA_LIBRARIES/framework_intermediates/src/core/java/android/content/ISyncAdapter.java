...
/**
 * Cast an IBinder object into an ISyncAdapter interface,
...
this.startSync(_arg0, _arg1, _arg2);
return true;
}
...
/**
     ...
     */
public void startSync(android.content.ISyncContext syncContext, java.lang.String account, android.os.Bundle extras) throws android.os.RemoteException
{
...
mRemote.transact(Stub.TRANSACTION_startSync, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_cancelSync, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
static final int TRANSACTION_startSync = (IBinder.FIRST_CALL_TRANSACTION + 0);
static final int TRANSACTION_cancelSync = (IBinder.FIRST_CALL_TRANSACTION + 1);
}
/**
     * Initiate a sync for this account. SyncAdapter-specific parameters may
     * be specified in extras, which is guaranteed to not be null.
