...
/**
 * Cast an IBinder object into an IInputMethodManager interface,
...
static final int TRANSACTION_getInputMethodList = (IBinder.FIRST_CALL_TRANSACTION + 0);
static final int TRANSACTION_getEnabledInputMethodList = (IBinder.FIRST_CALL_TRANSACTION + 1);
static final int TRANSACTION_addClient = (IBinder.FIRST_CALL_TRANSACTION + 2);
static final int TRANSACTION_removeClient = (IBinder.FIRST_CALL_TRANSACTION + 3);
static final int TRANSACTION_startInput = (IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_finishInput = (IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_showSoftInput = (IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_hideSoftInput = (IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_windowGainedFocus = (IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_showInputMethodPickerFromClient = (IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_setInputMethod = (IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_hideMySoftInput = (IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_showMySoftInput = (IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_updateStatusIcon = (IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_setInputMethodEnabled = (IBinder.FIRST_CALL_TRANSACTION + 14);
}
public java.util.List<android.view.inputmethod.InputMethodInfo> getInputMethodList() throws android.os.RemoteException;
public java.util.List<android.view.inputmethod.InputMethodInfo> getEnabledInputMethodList() throws android.os.RemoteException;
public void addClient(com.android.internal.view.IInputMethodClient client, com.android.internal.view.IInputContext inputContext, int uid, int pid) throws android.os.RemoteException;
