...
/**
 * Cast an IBinder object into an IExtendedNetworkService interface,
...
static final int TRANSACTION_setMmiString = (IBinder.FIRST_CALL_TRANSACTION + 0);
static final int TRANSACTION_getMmiRunningText = (IBinder.FIRST_CALL_TRANSACTION + 1);
static final int TRANSACTION_getUserMessage = (IBinder.FIRST_CALL_TRANSACTION + 2);
static final int TRANSACTION_clearMmiString = (IBinder.FIRST_CALL_TRANSACTION + 3);
}
/**
     * Set a MMI/USSD command to ExtendedNetworkService for further process. 
     * This should be called when a MMI command is placed from panel.
