...
/**
 * Cast an IBinder object into an IAppWidgetHost interface,
...
mRemote.transact(Stub.TRANSACTION_updateAppWidget, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
mRemote.transact(Stub.TRANSACTION_providerChanged, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
static final int TRANSACTION_updateAppWidget = (IBinder.FIRST_CALL_TRANSACTION + 0);
static final int TRANSACTION_providerChanged = (IBinder.FIRST_CALL_TRANSACTION + 1);
}
public void updateAppWidget(int appWidgetId, android.widget.RemoteViews views) throws android.os.RemoteException;
public void providerChanged(int appWidgetId, android.appwidget.AppWidgetProviderInfo info) throws android.os.RemoteException;
}
