...
/**
 * Cast an IBinder object into an INetStatService interface,
...
static final int TRANSACTION_getMobileTxPackets = (IBinder.FIRST_CALL_TRANSACTION + 0);
static final int TRANSACTION_getMobileRxPackets = (IBinder.FIRST_CALL_TRANSACTION + 1);
static final int TRANSACTION_getMobileTxBytes = (IBinder.FIRST_CALL_TRANSACTION + 2);
static final int TRANSACTION_getMobileRxBytes = (IBinder.FIRST_CALL_TRANSACTION + 3);
static final int TRANSACTION_getTotalTxPackets = (IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_getTotalRxPackets = (IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_getTotalTxBytes = (IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_getTotalRxBytes = (IBinder.FIRST_CALL_TRANSACTION + 7);
}
public long getMobileTxPackets() throws android.os.RemoteException;
public long getMobileRxPackets() throws android.os.RemoteException;
public long getMobileTxBytes() throws android.os.RemoteException;
