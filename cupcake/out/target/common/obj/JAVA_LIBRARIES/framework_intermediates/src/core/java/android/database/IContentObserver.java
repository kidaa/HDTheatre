...
/**
 * Cast an IBinder object into an IContentObserver interface,
...
mRemote.transact(Stub.TRANSACTION_onChange, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
static final int TRANSACTION_onChange = (IBinder.FIRST_CALL_TRANSACTION + 0);
}
/**
     * This method is called when an update occurs to the cursor that is being
     * observed. selfUpdate is true if the update was caused by a call to
