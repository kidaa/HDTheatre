...
this.notifyDataConnection(_arg0, _arg1, _arg2, _arg3, _arg4);
reply.writeNoException();
return true;
}
...
public void notifySignalStrength(int signalStrengthASU) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(signalStrengthASU);
...
public void notifyDataConnection(int state, boolean isDataConnectivityPossible, java.lang.String reason, java.lang.String apn, java.lang.String interfaceName) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
public void notifyDataConnectionFailed(java.lang.String reason) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
static final int TRANSACTION_listen = (IBinder.FIRST_CALL_TRANSACTION + 0);
static final int TRANSACTION_notifyCallState = (IBinder.FIRST_CALL_TRANSACTION + 1);
static final int TRANSACTION_notifyServiceState = (IBinder.FIRST_CALL_TRANSACTION + 2);
static final int TRANSACTION_notifySignalStrength = (IBinder.FIRST_CALL_TRANSACTION + 3);
static final int TRANSACTION_notifyMessageWaitingChanged = (IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_notifyCallForwardingChanged = (IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_notifyDataActivity = (IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_notifyDataConnection = (IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_notifyDataConnectionFailed = (IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_notifyCellLocation = (IBinder.FIRST_CALL_TRANSACTION + 9);
}
public void listen(java.lang.String pkg, com.android.internal.telephony.IPhoneStateListener callback, int events, boolean notifyNow) throws android.os.RemoteException;
public void notifyCallState(int state, java.lang.String incomingNumber) throws android.os.RemoteException;
public void notifyServiceState(android.telephony.ServiceState state) throws android.os.RemoteException;
