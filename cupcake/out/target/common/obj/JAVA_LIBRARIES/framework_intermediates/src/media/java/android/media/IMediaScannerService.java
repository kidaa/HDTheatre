...
/**
 * Cast an IBinder object into an IMediaScannerService interface,
...
static final int TRANSACTION_requestScanFile = (IBinder.FIRST_CALL_TRANSACTION + 0);
static final int TRANSACTION_scanFile = (IBinder.FIRST_CALL_TRANSACTION + 1);
}
/**
     * Requests the media scanner to scan a file.
     * @param path the path to the file to be scanned.
