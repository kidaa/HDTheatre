...
/**
 * Cast an IBinder object into an IParentalControlCallback interface,
...
mRemote.transact(Stub.TRANSACTION_onResult, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
static final int TRANSACTION_onResult = (IBinder.FIRST_CALL_TRANSACTION + 0);
}
public void onResult(com.google.android.net.ParentalControlState state) throws android.os.RemoteException;
}
