...
/**
 * Cast an IBinder object into an IThumbnailReceiver interface,
...
mRemote.transact(Stub.TRANSACTION_newThumbnail, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_finished, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
static final int TRANSACTION_newThumbnail = (IBinder.FIRST_CALL_TRANSACTION + 0);
static final int TRANSACTION_finished = (IBinder.FIRST_CALL_TRANSACTION + 1);
}
public void newThumbnail(int id, android.graphics.Bitmap thumbnail, java.lang.CharSequence description) throws android.os.RemoteException;
public void finished() throws android.os.RemoteException;
}
