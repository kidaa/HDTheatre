...
/**
 * Cast an IBinder object into an IInputMethodClient interface,
...
mRemote.transact(Stub.TRANSACTION_setUsingInputMethod, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
mRemote.transact(Stub.TRANSACTION_onBindMethod, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
mRemote.transact(Stub.TRANSACTION_onUnbindMethod, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
mRemote.transact(Stub.TRANSACTION_setActive, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
static final int TRANSACTION_setUsingInputMethod = (IBinder.FIRST_CALL_TRANSACTION + 0);
static final int TRANSACTION_onBindMethod = (IBinder.FIRST_CALL_TRANSACTION + 1);
static final int TRANSACTION_onUnbindMethod = (IBinder.FIRST_CALL_TRANSACTION + 2);
static final int TRANSACTION_setActive = (IBinder.FIRST_CALL_TRANSACTION + 3);
}
public void setUsingInputMethod(boolean state) throws android.os.RemoteException;
public void onBindMethod(com.android.internal.view.InputBindResult res) throws android.os.RemoteException;
public void onUnbindMethod(int sequence) throws android.os.RemoteException;
