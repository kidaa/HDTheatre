...
int _arg0;
_arg0 = data.readInt();
this.onDataConnectionStateChanged(_arg0);
return true;
}
...
mRemote.transact(Stub.TRANSACTION_onServiceStateChanged, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(asu);
mRemote.transact(Stub.TRANSACTION_onSignalStrengthChanged, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
mRemote.transact(Stub.TRANSACTION_onMessageWaitingIndicatorChanged, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
mRemote.transact(Stub.TRANSACTION_onCallForwardingIndicatorChanged, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
mRemote.transact(Stub.TRANSACTION_onCellLocationChanged, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
mRemote.transact(Stub.TRANSACTION_onCallStateChanged, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
}
public void onDataConnectionStateChanged(int state) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(state);
mRemote.transact(Stub.TRANSACTION_onDataConnectionStateChanged, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
mRemote.transact(Stub.TRANSACTION_onDataActivity, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
static final int TRANSACTION_onServiceStateChanged = (IBinder.FIRST_CALL_TRANSACTION + 0);
static final int TRANSACTION_onSignalStrengthChanged = (IBinder.FIRST_CALL_TRANSACTION + 1);
static final int TRANSACTION_onMessageWaitingIndicatorChanged = (IBinder.FIRST_CALL_TRANSACTION + 2);
static final int TRANSACTION_onCallForwardingIndicatorChanged = (IBinder.FIRST_CALL_TRANSACTION + 3);
static final int TRANSACTION_onCellLocationChanged = (IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_onCallStateChanged = (IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_onDataConnectionStateChanged = (IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_onDataActivity = (IBinder.FIRST_CALL_TRANSACTION + 7);
}
public void onServiceStateChanged(android.telephony.ServiceState serviceState) throws android.os.RemoteException;
public void onSignalStrengthChanged(int asu) throws android.os.RemoteException;
public void onMessageWaitingIndicatorChanged(boolean mwi) throws android.os.RemoteException;
