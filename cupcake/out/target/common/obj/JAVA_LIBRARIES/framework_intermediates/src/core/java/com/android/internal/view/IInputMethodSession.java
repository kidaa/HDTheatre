...
/**
 * Cast an IBinder object into an IInputMethodSession interface,
...
mRemote.transact(Stub.TRANSACTION_finishInput, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
mRemote.transact(Stub.TRANSACTION_updateExtractedText, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
mRemote.transact(Stub.TRANSACTION_updateSelection, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
mRemote.transact(Stub.TRANSACTION_updateCursor, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
mRemote.transact(Stub.TRANSACTION_displayCompletions, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
mRemote.transact(Stub.TRANSACTION_dispatchKeyEvent, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
_data.writeStrongBinder((((callback!=null))?(callback.asBinder()):(null)));
mRemote.transact(Stub.TRANSACTION_dispatchTrackballEvent, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
mRemote.transact(Stub.TRANSACTION_appPrivateCommand, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
mRemote.transact(Stub.TRANSACTION_toggleSoftInput, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
static final int TRANSACTION_finishInput = (IBinder.FIRST_CALL_TRANSACTION + 0);
static final int TRANSACTION_updateExtractedText = (IBinder.FIRST_CALL_TRANSACTION + 1);
static final int TRANSACTION_updateSelection = (IBinder.FIRST_CALL_TRANSACTION + 2);
static final int TRANSACTION_updateCursor = (IBinder.FIRST_CALL_TRANSACTION + 3);
static final int TRANSACTION_displayCompletions = (IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_dispatchKeyEvent = (IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_dispatchTrackballEvent = (IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_appPrivateCommand = (IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_toggleSoftInput = (IBinder.FIRST_CALL_TRANSACTION + 8);
}
public void finishInput() throws android.os.RemoteException;
public void updateExtractedText(int token, android.view.inputmethod.ExtractedText text) throws android.os.RemoteException;
public void updateSelection(int oldSelStart, int oldSelEnd, int newSelStart, int newSelEnd, int candidatesStart, int candidatesEnd) throws android.os.RemoteException;
