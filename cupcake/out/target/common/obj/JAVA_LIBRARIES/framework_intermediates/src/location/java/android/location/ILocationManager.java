...
java.util.List _result = this.getAllProviders();
...
java.util.List _result = this.getProviders(_arg0);
reply.writeNoException();
reply.writeList(_result);
return true;
}
case TRANSACTION_updateProviders:
{
data.enforceInterface(DESCRIPTOR);
...
android.location.ILocationListener _arg3;
_arg3 = android.location.ILocationListener.Stub.asInterface(data.readStrongBinder());
...
java.lang.String _result = this.getFromLocation(_arg0, _arg1, _arg2, _arg3, _arg4, _arg5, _arg6, _arg7);
reply.writeNoException();
...
java.util.List<android.location.Address> _arg10;
_arg10 = new java.util.ArrayList<android.location.Address>();
java.lang.String _result = this.getFromLocationName(_arg0, _arg1, _arg2, _arg3, _arg4, _arg5, _arg6, _arg7, _arg8, _arg9, _arg10);
reply.writeNoException();
reply.writeString(_result);
reply.writeTypedList(_arg10);
return true;
}
...
public java.util.List getProviders(boolean enabledOnly) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
java.util.List _result;
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_updateProviders, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
public void requestLocationUpdates(java.lang.String provider, long minTime, float minDistance, android.location.ILocationListener listener) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
public void requestLocationUpdatesPI(java.lang.String provider, long minTime, float minDistance, android.app.PendingIntent intent) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
public java.lang.String getFromLocation(double latitude, double longitude, int maxResults, java.lang.String language, java.lang.String country, java.lang.String variant, java.lang.String appName, java.util.List<android.location.Address> addrs) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
static final int TRANSACTION_getAllProviders = (IBinder.FIRST_CALL_TRANSACTION + 0);
static final int TRANSACTION_getProviders = (IBinder.FIRST_CALL_TRANSACTION + 1);
static final int TRANSACTION_updateProviders = (IBinder.FIRST_CALL_TRANSACTION + 2);
static final int TRANSACTION_requestLocationUpdates = (IBinder.FIRST_CALL_TRANSACTION + 3);
static final int TRANSACTION_requestLocationUpdatesPI = (IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_removeUpdates = (IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_removeUpdatesPI = (IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_addGpsStatusListener = (IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_removeGpsStatusListener = (IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_sendExtraCommand = (IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_addProximityAlert = (IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_removeProximityAlert = (IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_getProviderInfo = (IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_isProviderEnabled = (IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_getLastKnownLocation = (IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_getFromLocation = (IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_getFromLocationName = (IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_addTestProvider = (IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_removeTestProvider = (IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_setTestProviderLocation = (IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_clearTestProviderLocation = (IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_setTestProviderEnabled = (IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_clearTestProviderEnabled = (IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_setTestProviderStatus = (IBinder.FIRST_CALL_TRANSACTION + 23);
static final int TRANSACTION_clearTestProviderStatus = (IBinder.FIRST_CALL_TRANSACTION + 24);
}
public java.util.List getAllProviders() throws android.os.RemoteException;
public java.util.List getProviders(boolean enabledOnly) throws android.os.RemoteException;
public void updateProviders() throws android.os.RemoteException;
