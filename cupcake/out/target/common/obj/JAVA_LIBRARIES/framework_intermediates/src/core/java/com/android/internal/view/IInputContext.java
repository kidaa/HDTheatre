...
/**
 * Cast an IBinder object into an IInputContext interface,
...
mRemote.transact(Stub.TRANSACTION_getTextBeforeCursor, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
_data.writeInt(seq);
_data.writeStrongBinder((((callback!=null))?(callback.asBinder()):(null)));
mRemote.transact(Stub.TRANSACTION_getTextAfterCursor, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
_data.writeInt(seq);
_data.writeStrongBinder((((callback!=null))?(callback.asBinder()):(null)));
mRemote.transact(Stub.TRANSACTION_getCursorCapsMode, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
_data.writeInt(seq);
_data.writeStrongBinder((((callback!=null))?(callback.asBinder()):(null)));
mRemote.transact(Stub.TRANSACTION_getExtractedText, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
mRemote.transact(Stub.TRANSACTION_deleteSurroundingText, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
mRemote.transact(Stub.TRANSACTION_setComposingText, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_finishComposingText, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
_data.writeInt(newCursorPosition);
mRemote.transact(Stub.TRANSACTION_commitText, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
mRemote.transact(Stub.TRANSACTION_commitCompletion, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
_data.writeInt(end);
mRemote.transact(Stub.TRANSACTION_setSelection, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
mRemote.transact(Stub.TRANSACTION_performEditorAction, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(id);
mRemote.transact(Stub.TRANSACTION_performContextMenuAction, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_beginBatchEdit, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_endBatchEdit, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
mRemote.transact(Stub.TRANSACTION_reportFullscreenMode, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
mRemote.transact(Stub.TRANSACTION_sendKeyEvent, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
mRemote.transact(Stub.TRANSACTION_clearMetaKeyStates, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
mRemote.transact(Stub.TRANSACTION_performPrivateCommand, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
static final int TRANSACTION_getTextBeforeCursor = (IBinder.FIRST_CALL_TRANSACTION + 0);
static final int TRANSACTION_getTextAfterCursor = (IBinder.FIRST_CALL_TRANSACTION + 1);
static final int TRANSACTION_getCursorCapsMode = (IBinder.FIRST_CALL_TRANSACTION + 2);
static final int TRANSACTION_getExtractedText = (IBinder.FIRST_CALL_TRANSACTION + 3);
static final int TRANSACTION_deleteSurroundingText = (IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_setComposingText = (IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_finishComposingText = (IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_commitText = (IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_commitCompletion = (IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_setSelection = (IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_performEditorAction = (IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_performContextMenuAction = (IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_beginBatchEdit = (IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_endBatchEdit = (IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_reportFullscreenMode = (IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_sendKeyEvent = (IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_clearMetaKeyStates = (IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_performPrivateCommand = (IBinder.FIRST_CALL_TRANSACTION + 17);
}
public void getTextBeforeCursor(int length, int flags, int seq, com.android.internal.view.IInputContextCallback callback) throws android.os.RemoteException;
public void getTextAfterCursor(int length, int flags, int seq, com.android.internal.view.IInputContextCallback callback) throws android.os.RemoteException;
public void getCursorCapsMode(int reqModes, int seq, com.android.internal.view.IInputContextCallback callback) throws android.os.RemoteException;
