...
case TRANSACTION_getSimSerialNumber:
{
data.enforceInterface(DESCRIPTOR);
java.lang.String _result = this.getSimSerialNumber();
reply.writeNoException();
reply.writeString(_result);
return true;
}
...
/**
     ...
     */
public java.lang.String getSimSerialNumber() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
java.lang.String _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getSimSerialNumber, _data, _reply, 0);
_reply.readException();
_result = _reply.readString();
}
finally {
...
static final int TRANSACTION_getDeviceId = (IBinder.FIRST_CALL_TRANSACTION + 0);
static final int TRANSACTION_getDeviceSvn = (IBinder.FIRST_CALL_TRANSACTION + 1);
static final int TRANSACTION_getSubscriberId = (IBinder.FIRST_CALL_TRANSACTION + 2);
static final int TRANSACTION_getSimSerialNumber = (IBinder.FIRST_CALL_TRANSACTION + 3);
static final int TRANSACTION_getLine1Number = (IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_getLine1AlphaTag = (IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_getVoiceMailNumber = (IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_getVoiceMailAlphaTag = (IBinder.FIRST_CALL_TRANSACTION + 7);
}
/**
     * Retrieves the unique device ID, e.g., IMEI for GSM phones.
     */
