...
/**
 * Cast an IBinder object into an IOnKeyguardExitResult interface,
...
mRemote.transact(Stub.TRANSACTION_onKeyguardExitResult, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
static final int TRANSACTION_onKeyguardExitResult = (IBinder.FIRST_CALL_TRANSACTION + 0);
}
public void onKeyguardExitResult(boolean success) throws android.os.RemoteException;
}
