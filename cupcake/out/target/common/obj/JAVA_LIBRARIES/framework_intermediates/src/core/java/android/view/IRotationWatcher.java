...
mRemote.transact(Stub.TRANSACTION_onRotationChanged, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
static final int TRANSACTION_onRotationChanged = (IBinder.FIRST_CALL_TRANSACTION + 0);
}
public void onRotationChanged(int rotation) throws android.os.RemoteException;
}
