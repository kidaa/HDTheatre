...
/**
 * Cast an IBinder object into an IInputMethodCallback interface,
...
mRemote.transact(Stub.TRANSACTION_finishedEvent, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
mRemote.transact(Stub.TRANSACTION_sessionCreated, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
static final int TRANSACTION_finishedEvent = (IBinder.FIRST_CALL_TRANSACTION + 0);
static final int TRANSACTION_sessionCreated = (IBinder.FIRST_CALL_TRANSACTION + 1);
}
public void finishedEvent(int seq, boolean handled) throws android.os.RemoteException;
public void sessionCreated(com.android.internal.view.IInputMethodSession session) throws android.os.RemoteException;
}
