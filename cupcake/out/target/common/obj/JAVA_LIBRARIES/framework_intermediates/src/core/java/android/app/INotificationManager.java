...
/**
 * Cast an IBinder object into an INotificationManager interface,
...
static final int TRANSACTION_enqueueNotification = (IBinder.FIRST_CALL_TRANSACTION + 0);
static final int TRANSACTION_cancelNotification = (IBinder.FIRST_CALL_TRANSACTION + 1);
static final int TRANSACTION_cancelAllNotifications = (IBinder.FIRST_CALL_TRANSACTION + 2);
static final int TRANSACTION_enqueueToast = (IBinder.FIRST_CALL_TRANSACTION + 3);
static final int TRANSACTION_cancelToast = (IBinder.FIRST_CALL_TRANSACTION + 4);
}
public void enqueueNotification(java.lang.String pkg, int id, android.app.Notification notification, int[] idReceived) throws android.os.RemoteException;
public void cancelNotification(java.lang.String pkg, int id) throws android.os.RemoteException;
public void cancelAllNotifications(java.lang.String pkg) throws android.os.RemoteException;
