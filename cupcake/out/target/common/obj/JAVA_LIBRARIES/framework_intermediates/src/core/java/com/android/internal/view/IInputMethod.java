...
/**
 * Cast an IBinder object into an IInputMethod interface,
...
mRemote.transact(Stub.TRANSACTION_attachToken, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
mRemote.transact(Stub.TRANSACTION_bindInput, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_unbindInput, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
mRemote.transact(Stub.TRANSACTION_startInput, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
mRemote.transact(Stub.TRANSACTION_restartInput, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
mRemote.transact(Stub.TRANSACTION_createSession, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
mRemote.transact(Stub.TRANSACTION_setSessionEnabled, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeStrongBinder((((session!=null))?(session.asBinder()):(null)));
mRemote.transact(Stub.TRANSACTION_revokeSession, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
mRemote.transact(Stub.TRANSACTION_showSoftInput, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
mRemote.transact(Stub.TRANSACTION_hideSoftInput, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
static final int TRANSACTION_attachToken = (IBinder.FIRST_CALL_TRANSACTION + 0);
static final int TRANSACTION_bindInput = (IBinder.FIRST_CALL_TRANSACTION + 1);
static final int TRANSACTION_unbindInput = (IBinder.FIRST_CALL_TRANSACTION + 2);
static final int TRANSACTION_startInput = (IBinder.FIRST_CALL_TRANSACTION + 3);
static final int TRANSACTION_restartInput = (IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_createSession = (IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_setSessionEnabled = (IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_revokeSession = (IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_showSoftInput = (IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_hideSoftInput = (IBinder.FIRST_CALL_TRANSACTION + 9);
}
public void attachToken(android.os.IBinder token) throws android.os.RemoteException;
public void bindInput(android.view.inputmethod.InputBinding binding) throws android.os.RemoteException;
public void unbindInput() throws android.os.RemoteException;
