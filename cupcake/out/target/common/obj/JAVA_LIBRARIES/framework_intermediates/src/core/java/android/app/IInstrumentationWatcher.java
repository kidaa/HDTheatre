...
/**
 * Cast an IBinder object into an IInstrumentationWatcher interface,
...
mRemote.transact(Stub.TRANSACTION_instrumentationStatus, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
mRemote.transact(Stub.TRANSACTION_instrumentationFinished, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
static final int TRANSACTION_instrumentationStatus = (IBinder.FIRST_CALL_TRANSACTION + 0);
static final int TRANSACTION_instrumentationFinished = (IBinder.FIRST_CALL_TRANSACTION + 1);
}
public void instrumentationStatus(android.content.ComponentName name, int resultCode, android.os.Bundle results) throws android.os.RemoteException;
public void instrumentationFinished(android.content.ComponentName name, int resultCode, android.os.Bundle results) throws android.os.RemoteException;
}
