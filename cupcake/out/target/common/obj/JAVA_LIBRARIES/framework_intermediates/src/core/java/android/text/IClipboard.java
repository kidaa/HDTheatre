...
/**
 * Cast an IBinder object into an IClipboard interface,
...
static final int TRANSACTION_getClipboardText = (IBinder.FIRST_CALL_TRANSACTION + 0);
static final int TRANSACTION_setClipboardText = (IBinder.FIRST_CALL_TRANSACTION + 1);
static final int TRANSACTION_hasClipboardText = (IBinder.FIRST_CALL_TRANSACTION + 2);
}
/**
     * Returns the text on the clipboard.  It will eventually be possible
     * to store types other than text too, in which case this will return
