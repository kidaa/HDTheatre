...
/**
 * Cast an IBinder object into an IApplicationToken interface,
...
static final int TRANSACTION_windowsVisible = (IBinder.FIRST_CALL_TRANSACTION + 0);
static final int TRANSACTION_windowsGone = (IBinder.FIRST_CALL_TRANSACTION + 1);
static final int TRANSACTION_keyDispatchingTimedOut = (IBinder.FIRST_CALL_TRANSACTION + 2);
static final int TRANSACTION_getKeyDispatchingTimeout = (IBinder.FIRST_CALL_TRANSACTION + 3);
}
public void windowsVisible() throws android.os.RemoteException;
public void windowsGone() throws android.os.RemoteException;
public boolean keyDispatchingTimedOut() throws android.os.RemoteException;
