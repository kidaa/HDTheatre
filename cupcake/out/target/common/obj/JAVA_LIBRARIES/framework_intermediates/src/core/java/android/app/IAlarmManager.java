...
/**
 * Cast an IBinder object into an IAlarmManager interface,
...
static final int TRANSACTION_set = (IBinder.FIRST_CALL_TRANSACTION + 0);
static final int TRANSACTION_setRepeating = (IBinder.FIRST_CALL_TRANSACTION + 1);
static final int TRANSACTION_setInexactRepeating = (IBinder.FIRST_CALL_TRANSACTION + 2);
static final int TRANSACTION_setTimeZone = (IBinder.FIRST_CALL_TRANSACTION + 3);
static final int TRANSACTION_remove = (IBinder.FIRST_CALL_TRANSACTION + 4);
}
public void set(int type, long triggerAtTime, android.app.PendingIntent operation) throws android.os.RemoteException;
public void setRepeating(int type, long triggerAtTime, long interval, android.app.PendingIntent operation) throws android.os.RemoteException;
public void setInexactRepeating(int type, long triggerAtTime, long interval, android.app.PendingIntent operation) throws android.os.RemoteException;
