...
public void notePhoneSignalStrength(int asu) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
static final int TRANSACTION_noteWifiOn = (IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_noteWifiOff = (IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_noteWifiRunning = (IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_noteWifiStopped = (IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_noteBluetoothOn = (IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_noteBluetoothOff = (IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_noteFullWifiLockAcquired = (IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_noteFullWifiLockReleased = (IBinder.FIRST_CALL_TRANSACTION + 23);
static final int TRANSACTION_noteScanWifiLockAcquired = (IBinder.FIRST_CALL_TRANSACTION + 24);
static final int TRANSACTION_noteScanWifiLockReleased = (IBinder.FIRST_CALL_TRANSACTION + 25);
static final int TRANSACTION_setOnBattery = (IBinder.FIRST_CALL_TRANSACTION + 26);
static final int TRANSACTION_getAwakeTimeBattery = (IBinder.FIRST_CALL_TRANSACTION + 27);
static final int TRANSACTION_getAwakeTimePlugged = (IBinder.FIRST_CALL_TRANSACTION + 28);
}
public byte[] getStatistics() throws android.os.RemoteException;
public void noteStartWakelock(int uid, java.lang.String name, int type) throws android.os.RemoteException;
public void noteStopWakelock(int uid, java.lang.String name, int type) throws android.os.RemoteException;
