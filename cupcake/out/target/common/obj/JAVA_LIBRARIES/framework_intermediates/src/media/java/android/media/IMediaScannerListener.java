...
/**
 * Cast an IBinder object into an IMediaScannerListener interface,
...
mRemote.transact(Stub.TRANSACTION_scanCompleted, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
static final int TRANSACTION_scanCompleted = (IBinder.FIRST_CALL_TRANSACTION + 0);
}
/**
     * Called when a IMediaScannerService.scanFile() call has completed.
     * @param path the path to the file that has been scanned.
