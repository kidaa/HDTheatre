...
case TRANSACTION_getDataChanel:
{
data.enforceInterface(DESCRIPTOR);
android.os.ParcelFileDescriptor _result = this.getDataChanel();
...
mRemote.transact(Stub.TRANSACTION_getDataChanel, _data, _reply, 0);
...
static final int TRANSACTION_getDataChanel = (IBinder.FIRST_CALL_TRANSACTION + 0);
