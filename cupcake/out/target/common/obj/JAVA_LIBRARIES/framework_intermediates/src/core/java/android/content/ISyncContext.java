...
/**
 * Cast an IBinder object into an ISyncContext interface,
...
static final int TRANSACTION_sendHeartbeat = (IBinder.FIRST_CALL_TRANSACTION + 0);
static final int TRANSACTION_onFinished = (IBinder.FIRST_CALL_TRANSACTION + 1);
}
/**
     * Call to indicate that the SyncAdapter is making progress. E.g., if this SyncAdapter
     * downloads or sends records to/from the server, this may be called after each record
