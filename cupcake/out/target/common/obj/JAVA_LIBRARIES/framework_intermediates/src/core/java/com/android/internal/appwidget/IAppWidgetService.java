...
/**
 * Cast an IBinder object into an IAppWidgetService interface,
...
static final int TRANSACTION_startListening = (IBinder.FIRST_CALL_TRANSACTION + 0);
static final int TRANSACTION_stopListening = (IBinder.FIRST_CALL_TRANSACTION + 1);
static final int TRANSACTION_allocateAppWidgetId = (IBinder.FIRST_CALL_TRANSACTION + 2);
static final int TRANSACTION_deleteAppWidgetId = (IBinder.FIRST_CALL_TRANSACTION + 3);
static final int TRANSACTION_deleteHost = (IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_deleteAllHosts = (IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_getAppWidgetViews = (IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_updateAppWidgetIds = (IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_updateAppWidgetProvider = (IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_getInstalledProviders = (IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_getAppWidgetInfo = (IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_bindAppWidgetId = (IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_getAppWidgetIds = (IBinder.FIRST_CALL_TRANSACTION + 12);
}
//
// for AppWidgetHost
//
