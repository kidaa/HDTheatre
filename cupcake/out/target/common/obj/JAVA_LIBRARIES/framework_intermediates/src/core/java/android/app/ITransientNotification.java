...
/**
 * Cast an IBinder object into an ITransientNotification interface,
...
mRemote.transact(Stub.TRANSACTION_show, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_hide, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
static final int TRANSACTION_show = (IBinder.FIRST_CALL_TRANSACTION + 0);
static final int TRANSACTION_hide = (IBinder.FIRST_CALL_TRANSACTION + 1);
}
public void show() throws android.os.RemoteException;
public void hide() throws android.os.RemoteException;
}
