...
public static abstract class Stub extends android.os.Binder implements com.android.inputmethod.pinyin.IPinyinDecoderService
{
private static final java.lang.String DESCRIPTOR = "com.android.inputmethod.pinyin.IPinyinDecoderService";
...
/**
 * Cast an IBinder object into an IPinyinDecoderService interface,
 * generating a proxy if needed.
 */
public static com.android.inputmethod.pinyin.IPinyinDecoderService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = (android.os.IInterface)obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.android.inputmethod.pinyin.IPinyinDecoderService))) {
return ((com.android.inputmethod.pinyin.IPinyinDecoderService)iin);
}
return new com.android.inputmethod.pinyin.IPinyinDecoderService.Stub.Proxy(obj);
}
...
private static class Proxy implements com.android.inputmethod.pinyin.IPinyinDecoderService
{
...
static final int TRANSACTION_getInt = (IBinder.FIRST_CALL_TRANSACTION + 0);
static final int TRANSACTION_setMaxLens = (IBinder.FIRST_CALL_TRANSACTION + 1);
static final int TRANSACTION_imSearch = (IBinder.FIRST_CALL_TRANSACTION + 2);
static final int TRANSACTION_imDelSearch = (IBinder.FIRST_CALL_TRANSACTION + 3);
static final int TRANSACTION_imResetSearch = (IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_imAddLetter = (IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_imGetPyStr = (IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_imGetPyStrLen = (IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_imGetSplStart = (IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_imGetChoice = (IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_imGetChoices = (IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_imGetChoiceList = (IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_imChoose = (IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_imCancelLastChoice = (IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_imGetFixedLen = (IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_imCancelInput = (IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_imFlushCache = (IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_imGetPredictsNum = (IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_imGetPredictList = (IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_imGetPredictItem = (IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_syncUserDict = (IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_syncBegin = (IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_syncFinish = (IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_syncPutLemmas = (IBinder.FIRST_CALL_TRANSACTION + 23);
static final int TRANSACTION_syncGetLemmas = (IBinder.FIRST_CALL_TRANSACTION + 24);
static final int TRANSACTION_syncGetLastCount = (IBinder.FIRST_CALL_TRANSACTION + 25);
static final int TRANSACTION_syncGetTotalCount = (IBinder.FIRST_CALL_TRANSACTION + 26);
static final int TRANSACTION_syncClearLastGot = (IBinder.FIRST_CALL_TRANSACTION + 27);
static final int TRANSACTION_imSyncGetCapacity = (IBinder.FIRST_CALL_TRANSACTION + 28);
}
public int getInt() throws android.os.RemoteException;
public void setMaxLens(int maxSpsLen, int maxHzsLen) throws android.os.RemoteException;
public int imSearch(byte[] pyBuf, int pyLen) throws android.os.RemoteException;
