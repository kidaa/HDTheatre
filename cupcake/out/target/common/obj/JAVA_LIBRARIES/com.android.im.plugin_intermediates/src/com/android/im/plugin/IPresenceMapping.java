 ...
 * Original file: packages/apps/IM/plugin/com/android/im/plugin/IPresenceMapping.aidl
 */
...
public static abstract class Stub extends android.os.Binder implements com.android.im.plugin.IPresenceMapping
{
private static final java.lang.String DESCRIPTOR = "com.android.im.plugin.IPresenceMapping";
 ...
 */
public static com.android.im.plugin.IPresenceMapping asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = (android.os.IInterface)obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.android.im.plugin.IPresenceMapping))) {
return ((com.android.im.plugin.IPresenceMapping)iin);
}
return new com.android.im.plugin.IPresenceMapping.Stub.Proxy(obj);
}
...
private static class Proxy implements com.android.im.plugin.IPresenceMapping
{
