...
public  java.nio.FloatBuffer get(float[] dest) { throw new RuntimeException("Stub!"); }
public  java.nio.FloatBuffer get(float[] dest, int off, int len) { throw new RuntimeException("Stub!"); }
