...
public  HashMap(int capacity) { throw new RuntimeException("Stub!"); }
public  HashMap(int capacity, float loadFactor) { throw new RuntimeException("Stub!"); }
public  HashMap(java.util.Map<? extends K, ? extends V> map) { throw new RuntimeException("Stub!"); }
