...
public  EnumMap(java.util.EnumMap<K, ? extends V> map) { throw new RuntimeException("Stub!"); }
public  EnumMap(java.util.Map<K, ? extends V> map) { throw new RuntimeException("Stub!"); }
