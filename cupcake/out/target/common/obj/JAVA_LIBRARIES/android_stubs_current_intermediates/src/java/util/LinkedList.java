...
public class LinkedList<E>
  ...
  implements java.util.List<E>, java.util.Queue<E>, java.lang.Cloneable, java.io.Serializable
{
public  LinkedList() { throw new RuntimeException("Stub!"); }
public  LinkedList(java.util.Collection<? extends E> collection) { throw new RuntimeException("Stub!"); }
...
public  void addFirst(E object) { throw new RuntimeException("Stub!"); }
public  void addLast(E object) { throw new RuntimeException("Stub!"); }
