...
public  java.nio.ByteBuffer get(byte[] dest) { throw new RuntimeException("Stub!"); }
public  java.nio.ByteBuffer get(byte[] dest, int off, int len) { throw new RuntimeException("Stub!"); }
