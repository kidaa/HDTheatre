...
protected static  long getLong(byte[] buf, int offset) { throw new RuntimeException("Stub!"); }
protected static  int getInt(byte[] buf, int offset) { throw new RuntimeException("Stub!"); }
protected static  short getShort(byte[] buf, int offset) { throw new RuntimeException("Stub!"); }
