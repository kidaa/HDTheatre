...
public  java.nio.IntBuffer get(int[] dest) { throw new RuntimeException("Stub!"); }
public  java.nio.IntBuffer get(int[] dest, int off, int len) { throw new RuntimeException("Stub!"); }
