...
public  Float(java.lang.String string) throws java.lang.NumberFormatException { throw new RuntimeException("Stub!"); }
public  int compareTo(java.lang.Float object) { throw new RuntimeException("Stub!"); }
...
public static  boolean isInfinite(float f) { throw new RuntimeException("Stub!"); }
public  boolean isNaN() { throw new RuntimeException("Stub!"); }
public static  boolean isNaN(float f) { throw new RuntimeException("Stub!"); }
public  long longValue() { throw new RuntimeException("Stub!"); }
public static  float parseFloat(java.lang.String string) throws java.lang.NumberFormatException { throw new RuntimeException("Stub!"); }
...
public static  java.lang.Float valueOf(java.lang.String string) throws java.lang.NumberFormatException { throw new RuntimeException("Stub!"); }
public static  int compare(float float1, float float2) { throw new RuntimeException("Stub!"); }
