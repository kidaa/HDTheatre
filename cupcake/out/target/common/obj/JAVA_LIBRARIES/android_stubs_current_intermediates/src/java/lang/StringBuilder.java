...
public  StringBuilder(java.lang.CharSequence seq) { throw new RuntimeException("Stub!"); }
public  StringBuilder(java.lang.String str) { throw new RuntimeException("Stub!"); }
...
public  java.lang.StringBuilder append(java.lang.Object obj) { throw new RuntimeException("Stub!"); }
public  java.lang.StringBuilder append(java.lang.String str) { throw new RuntimeException("Stub!"); }
public  java.lang.StringBuilder append(java.lang.StringBuffer sb) { throw new RuntimeException("Stub!"); }
public  java.lang.StringBuilder append(char[] ch) { throw new RuntimeException("Stub!"); }
public  java.lang.StringBuilder append(char[] str, int offset, int len) { throw new RuntimeException("Stub!"); }
public  java.lang.StringBuilder append(java.lang.CharSequence csq) { throw new RuntimeException("Stub!"); }
public  java.lang.StringBuilder append(java.lang.CharSequence csq, int start, int end) { throw new RuntimeException("Stub!"); }
...
public  java.lang.StringBuilder insert(int offset, java.lang.Object obj) { throw new RuntimeException("Stub!"); }
public  java.lang.StringBuilder insert(int offset, java.lang.String str) { throw new RuntimeException("Stub!"); }
public  java.lang.StringBuilder insert(int offset, char[] ch) { throw new RuntimeException("Stub!"); }
public  java.lang.StringBuilder insert(int offset, char[] str, int strOffset, int strLen) { throw new RuntimeException("Stub!"); }
public  java.lang.StringBuilder insert(int offset, java.lang.CharSequence s) { throw new RuntimeException("Stub!"); }
public  java.lang.StringBuilder insert(int offset, java.lang.CharSequence s, int start, int end) { throw new RuntimeException("Stub!"); }
public  java.lang.StringBuilder replace(int start, int end, java.lang.String str) { throw new RuntimeException("Stub!"); }
