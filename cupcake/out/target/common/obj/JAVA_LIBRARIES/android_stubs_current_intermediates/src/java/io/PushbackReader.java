...
{
public  PushbackReader(java.io.Reader in) { super((java.io.Reader)null); throw new RuntimeException("Stub!"); }
public  PushbackReader(java.io.Reader in, int size) { super((java.io.Reader)null); throw new RuntimeException("Stub!"); }
...
public  void unread(char[] buffer) throws java.io.IOException { throw new RuntimeException("Stub!"); }
public  void unread(char[] buffer, int offset, int count) throws java.io.IOException { throw new RuntimeException("Stub!"); }
public  void unread(int oneChar) throws java.io.IOException { throw new RuntimeException("Stub!"); }
