...
public final  java.nio.channels.FileChannel getChannel() { throw new RuntimeException("Stub!"); }
...
public  void seek(long pos) throws java.io.IOException { throw new RuntimeException("Stub!"); }
