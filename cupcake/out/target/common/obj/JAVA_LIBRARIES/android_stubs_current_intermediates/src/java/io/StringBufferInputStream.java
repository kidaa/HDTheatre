...
{
public  StringBufferInputStream(java.lang.String str) { throw new RuntimeException("Stub!"); }
...
public synchronized  int read(byte[] b, int offset, int length) { throw new RuntimeException("Stub!"); }
