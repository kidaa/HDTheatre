...
protected  Socket(java.net.SocketImpl anImpl) throws java.net.SocketException { throw new RuntimeException("Stub!"); }
...
public  void setKeepAlive(boolean value) throws java.net.SocketException { throw new RuntimeException("Stub!"); }
