...
public  InflaterInputStream(java.io.InputStream is, java.util.zip.Inflater inf) { super((java.io.InputStream)null); throw new RuntimeException("Stub!"); }
public  InflaterInputStream(java.io.InputStream is, java.util.zip.Inflater inf, int bsize) { super((java.io.InputStream)null); throw new RuntimeException("Stub!"); }
...
public  long skip(long nbytes) throws java.io.IOException { throw new RuntimeException("Stub!"); }
