...
public  void schedule(java.util.TimerTask task, java.util.Date when) { throw new RuntimeException("Stub!"); }
...
public  void schedule(java.util.TimerTask task, java.util.Date when, long period) { throw new RuntimeException("Stub!"); }
public  void scheduleAtFixedRate(java.util.TimerTask task, long delay, long period) { throw new RuntimeException("Stub!"); }
public  void scheduleAtFixedRate(java.util.TimerTask task, java.util.Date when, long period) { throw new RuntimeException("Stub!"); }
}
