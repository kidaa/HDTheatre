...
public native  float measureText(java.lang.String text, int start, int end);
public native  float measureText(java.lang.String text);
public  float measureText(java.lang.CharSequence text, int start, int end) { throw new RuntimeException("Stub!"); }
public native  int breakText(char[] text, int index, int count, float maxWidth, float[] measuredWidth);
...
public native  int breakText(java.lang.String text, boolean measureForwards, float maxWidth, float[] measuredWidth);
