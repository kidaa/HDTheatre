...
{
public  Scanner(java.io.File src) throws java.io.FileNotFoundException { throw new RuntimeException("Stub!"); }
public  Scanner(java.io.File src, java.lang.String charsetName) throws java.io.FileNotFoundException { throw new RuntimeException("Stub!"); }
public  Scanner(java.lang.String src) { throw new RuntimeException("Stub!"); }
public  Scanner(java.io.InputStream src) { throw new RuntimeException("Stub!"); }
public  Scanner(java.io.InputStream src, java.lang.String charsetName) { throw new RuntimeException("Stub!"); }
public  Scanner(java.lang.Readable src) { throw new RuntimeException("Stub!"); }
public  Scanner(java.nio.channels.ReadableByteChannel src) { throw new RuntimeException("Stub!"); }
public  Scanner(java.nio.channels.ReadableByteChannel src, java.lang.String charsetName) { throw new RuntimeException("Stub!"); }
...
public  java.util.Scanner useLocale(java.util.Locale l) { throw new RuntimeException("Stub!"); }
