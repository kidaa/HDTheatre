...
public class Activity
  ...
  implements android.view.LayoutInflater.Factory, android.view.Window.Callback, android.view.KeyEvent.Callback, android.view.View.OnCreateContextMenuListener, android.content.ComponentCallbacks
{
public  Activity() { throw new RuntimeException("Stub!"); }
protected  void finalize() throws java.lang.Throwable { throw new RuntimeException("Stub!"); }
public static  long getInstanceCount() { throw new RuntimeException("Stub!"); }
...
public  void setPersistent(boolean isPersistent) { throw new RuntimeException("Stub!"); }
