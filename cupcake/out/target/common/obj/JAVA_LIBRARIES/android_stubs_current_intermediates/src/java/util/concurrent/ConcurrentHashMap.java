...
public  ConcurrentHashMap(java.util.Map<? extends K, ? extends V> t) { throw new RuntimeException("Stub!"); }
...
public  void putAll(java.util.Map<? extends K, ? extends V> t) { throw new RuntimeException("Stub!"); }
