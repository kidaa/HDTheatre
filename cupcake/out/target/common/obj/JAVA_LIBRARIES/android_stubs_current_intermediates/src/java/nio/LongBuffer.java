...
public  java.nio.LongBuffer get(long[] dest) { throw new RuntimeException("Stub!"); }
public  java.nio.LongBuffer get(long[] dest, int off, int len) { throw new RuntimeException("Stub!"); }
