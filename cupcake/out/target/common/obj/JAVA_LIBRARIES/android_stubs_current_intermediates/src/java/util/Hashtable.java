...
public  Hashtable(int capacity) { throw new RuntimeException("Stub!"); }
public  Hashtable(int capacity, float loadFactor) { throw new RuntimeException("Stub!"); }
public  Hashtable(java.util.Map<? extends K, ? extends V> map) { throw new RuntimeException("Stub!"); }
...
public synchronized  void putAll(java.util.Map<? extends K, ? extends V> map) { throw new RuntimeException("Stub!"); }
