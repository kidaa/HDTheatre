...
{
public  URI(java.lang.String uri) throws java.net.URISyntaxException { throw new RuntimeException("Stub!"); }
public  URI(java.lang.String scheme, java.lang.String ssp, java.lang.String frag) throws java.net.URISyntaxException { throw new RuntimeException("Stub!"); }
...
public  int compareTo(java.net.URI uri) { throw new RuntimeException("Stub!"); }
public static  java.net.URI create(java.lang.String uri) { throw new RuntimeException("Stub!"); }
...
public  java.net.URI relativize(java.net.URI relative) { throw new RuntimeException("Stub!"); }
public  java.net.URI resolve(java.net.URI relative) { throw new RuntimeException("Stub!"); }
public  java.net.URI resolve(java.lang.String relative) { throw new RuntimeException("Stub!"); }
