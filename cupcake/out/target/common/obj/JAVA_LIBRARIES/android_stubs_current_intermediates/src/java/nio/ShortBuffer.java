...
public  java.nio.ShortBuffer get(short[] dest) { throw new RuntimeException("Stub!"); }
public  java.nio.ShortBuffer get(short[] dest, int off, int len) { throw new RuntimeException("Stub!"); }
