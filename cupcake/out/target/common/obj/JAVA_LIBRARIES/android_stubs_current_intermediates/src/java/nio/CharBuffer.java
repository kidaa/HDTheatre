...
public  java.nio.CharBuffer get(char[] dest) { throw new RuntimeException("Stub!"); }
public  java.nio.CharBuffer get(char[] dest, int off, int len) { throw new RuntimeException("Stub!"); }
