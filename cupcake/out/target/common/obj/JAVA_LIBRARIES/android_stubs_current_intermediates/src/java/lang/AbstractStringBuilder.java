...
public  void ensureCapacity(int min) { throw new RuntimeException("Stub!"); }
public  void getChars(int start, int end, char[] dest, int destStart) { throw new RuntimeException("Stub!"); }
public  int length() { throw new RuntimeException("Stub!"); }
public  void setCharAt(int index, char ch) { throw new RuntimeException("Stub!"); }
public  void setLength(int length) { throw new RuntimeException("Stub!"); }
