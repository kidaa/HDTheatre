...
public  java.nio.DoubleBuffer get(double[] dest) { throw new RuntimeException("Stub!"); }
public  java.nio.DoubleBuffer get(double[] dest, int off, int len) { throw new RuntimeException("Stub!"); }
