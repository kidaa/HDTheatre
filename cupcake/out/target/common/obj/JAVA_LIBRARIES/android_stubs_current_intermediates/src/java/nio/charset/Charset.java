...
{
protected  Charset(java.lang.String canonicalName, java.lang.String[] aliases) throws java.nio.charset.IllegalCharsetNameException { throw new RuntimeException("Stub!"); }
...
public static  java.nio.charset.Charset forName(java.lang.String charsetName) throws java.nio.charset.IllegalCharsetNameException, java.nio.charset.UnsupportedCharsetException { throw new RuntimeException("Stub!"); }
public static  boolean isSupported(java.lang.String charsetName) throws java.nio.charset.IllegalCharsetNameException { throw new RuntimeException("Stub!"); }
...
public final synchronized  java.nio.ByteBuffer encode(java.nio.CharBuffer buffer) { throw new RuntimeException("Stub!"); }
