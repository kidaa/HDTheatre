...
const int CSSValueEase = 361;
const int CSSValueLinear = 362;
const int CSSValueEaseIn = 363;
const int CSSValueEaseOut = 364;
const int CSSValueEaseInOut = 365;
const int CSSValueDocument = 366;
const int CSSValueReset = 367;
const int CSSValueVisiblepainted = 368;
const int CSSValueVisiblefill = 369;
const int CSSValueVisiblestroke = 370;
const int CSSValuePainted = 371;
const int CSSValueFill = 372;
const int CSSValueStroke = 373;
const int numCSSValueKeywords = 374;
