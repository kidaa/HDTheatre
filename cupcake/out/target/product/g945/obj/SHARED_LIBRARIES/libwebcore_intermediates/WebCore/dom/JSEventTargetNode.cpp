...
static const HashTableValue JSEventTargetNodeTableValues[45] =
{
    ...
    { "ontouchstart", DontDelete|DontEnum, (intptr_t)jsEventTargetNodeOntouchstart, (intptr_t)setJSEventTargetNodeOntouchstart },
    { "ontouchend", DontDelete|DontEnum, (intptr_t)jsEventTargetNodeOntouchend, (intptr_t)setJSEventTargetNodeOntouchend },
    { "ontouchmove", DontDelete|DontEnum, (intptr_t)jsEventTargetNodeOntouchmove, (intptr_t)setJSEventTargetNodeOntouchmove },
    { "ontouchcancel", DontDelete|DontEnum, (intptr_t)jsEventTargetNodeOntouchcancel, (intptr_t)setJSEventTargetNodeOntouchcancel },
    { 0, 0, 0, 0 }
};

static const HashTable JSEventTargetNodeTable =
#if ENABLE(PERFECT_HASH_SIZE)
    { 8191, JSEventTargetNodeTableValues, 0 };
#else
    { 136, 127, JSEventTargetNodeTableValues, 0 };
#endif
...
JSValuePtr jsEventTargetNodeOntouchstart(ExecState* exec, const Identifier&, const PropertySlot& slot)
{
    UNUSED_PARAM(exec);
    EventTargetNode* imp = static_cast<EventTargetNode*>(static_cast<JSEventTargetNode*>(asObject(slot.slotBase()))->impl());
...
JSValuePtr jsEventTargetNodeOntouchend(ExecState* exec, const Identifier&, const PropertySlot& slot)
{
    UNUSED_PARAM(exec);
    EventTargetNode* imp = static_cast<EventTargetNode*>(static_cast<JSEventTargetNode*>(asObject(slot.slotBase()))->impl());
...
JSValuePtr jsEventTargetNodeOntouchmove(ExecState* exec, const Identifier&, const PropertySlot& slot)
{
    UNUSED_PARAM(exec);
    EventTargetNode* imp = static_cast<EventTargetNode*>(static_cast<JSEventTargetNode*>(asObject(slot.slotBase()))->impl());
...
JSValuePtr jsEventTargetNodeOntouchcancel(ExecState* exec, const Identifier&, const PropertySlot& slot)
{
    UNUSED_PARAM(exec);
    EventTargetNode* imp = static_cast<EventTargetNode*>(static_cast<JSEventTargetNode*>(asObject(slot.slotBase()))->impl());
...
void setJSEventTargetNodeOntouchstart(ExecState* exec, JSObject* thisObject, JSValuePtr value)
{
    EventTargetNode* imp = static_cast<EventTargetNode*>(static_cast<JSEventTargetNode*>(thisObject)->impl());
    JSDOMGlobalObject* globalObject = toJSDOMGlobalObject(imp->scriptExecutionContext());
    if (!globalObject)
...
void setJSEventTargetNodeOntouchend(ExecState* exec, JSObject* thisObject, JSValuePtr value)
{
    EventTargetNode* imp = static_cast<EventTargetNode*>(static_cast<JSEventTargetNode*>(thisObject)->impl());
    JSDOMGlobalObject* globalObject = toJSDOMGlobalObject(imp->scriptExecutionContext());
    if (!globalObject)
...
void setJSEventTargetNodeOntouchmove(ExecState* exec, JSObject* thisObject, JSValuePtr value)
{
    EventTargetNode* imp = static_cast<EventTargetNode*>(static_cast<JSEventTargetNode*>(thisObject)->impl());
    JSDOMGlobalObject* globalObject = toJSDOMGlobalObject(imp->scriptExecutionContext());
    if (!globalObject)
...
void setJSEventTargetNodeOntouchcancel(ExecState* exec, JSObject* thisObject, JSValuePtr value)
{
    EventTargetNode* imp = static_cast<EventTargetNode*>(static_cast<JSEventTargetNode*>(thisObject)->impl());
    JSDOMGlobalObject* globalObject = toJSDOMGlobalObject(imp->scriptExecutionContext());
    if (!globalObject)
