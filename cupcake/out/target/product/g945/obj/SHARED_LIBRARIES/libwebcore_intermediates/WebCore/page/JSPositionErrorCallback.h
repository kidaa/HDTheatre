...
JSC::JSValuePtr toJS(JSC::ExecState*, PositionErrorCallback*);
PositionErrorCallback* toPositionErrorCallback(JSC::JSValuePtr);
...
JSC::JSValuePtr jsPositionErrorCallbackPrototypeFunctionHandleEvent(JSC::ExecState*, JSC::JSObject*, JSC::JSValuePtr, const JSC::ArgList&);
// Attributes

JSC::JSValuePtr jsPositionErrorCallbackConstructor(JSC::ExecState*, const JSC::Identifier&, const JSC::PropertySlot&);
