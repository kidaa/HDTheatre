...
static const HashTableValue JSDOMWindowTableValues[207] =
{
    ...
    { "orientation", DontDelete, (intptr_t)jsDOMWindowOrientation, (intptr_t)setJSDOMWindowOrientation },
...
static const HashTable JSDOMWindowTable =
    ...
    { 16383, JSDOMWindowTableValues, 0 };
#else
    { 542, 511, JSDOMWindowTableValues, 0 };
#endif

/* Hash table for prototype */

static const HashTableValue JSDOMWindowPrototypeTableValues[29] =
{
...
JSValuePtr jsDOMWindowOrientation(ExecState* exec, const Identifier&, const PropertySlot& slot)
{
    if (!static_cast<JSDOMWindow*>(asObject(slot.slotBase()))->allowsAccessFrom(exec))
        return jsUndefined();
    UNUSED_PARAM(exec);
...
JSValuePtr jsDOMWindowOntouchstart(ExecState* exec, const Identifier&, const PropertySlot& slot)
{
    if (!static_cast<JSDOMWindow*>(asObject(slot.slotBase()))->allowsAccessFrom(exec))
        return jsUndefined();
    UNUSED_PARAM(exec);
    DOMWindow* imp = static_cast<DOMWindow*>(static_cast<JSDOMWindow*>(asObject(slot.slotBase()))->impl());
    if (JSEventListener* listener = static_cast<JSEventListener*>(imp->ontouchstart())) {
        if (JSObject* listenerObj = listener->listenerObj())
            return listenerObj;
    }
    return jsNull();
...
JSValuePtr jsDOMWindowOntouchend(ExecState* exec, const Identifier&, const PropertySlot& slot)
{
    if (!static_cast<JSDOMWindow*>(asObject(slot.slotBase()))->allowsAccessFrom(exec))
        return jsUndefined();
    UNUSED_PARAM(exec);
    DOMWindow* imp = static_cast<DOMWindow*>(static_cast<JSDOMWindow*>(asObject(slot.slotBase()))->impl());
    if (JSEventListener* listener = static_cast<JSEventListener*>(imp->ontouchend())) {
        if (JSObject* listenerObj = listener->listenerObj())
            return listenerObj;
    }
    return jsNull();
...
JSValuePtr jsDOMWindowOntouchmove(ExecState* exec, const Identifier&, const PropertySlot& slot)
{
    if (!static_cast<JSDOMWindow*>(asObject(slot.slotBase()))->allowsAccessFrom(exec))
        return jsUndefined();
    UNUSED_PARAM(exec);
    DOMWindow* imp = static_cast<DOMWindow*>(static_cast<JSDOMWindow*>(asObject(slot.slotBase()))->impl());
    if (JSEventListener* listener = static_cast<JSEventListener*>(imp->ontouchmove())) {
        if (JSObject* listenerObj = listener->listenerObj())
            return listenerObj;
    }
    return jsNull();
...
JSValuePtr jsDOMWindowOntouchcancel(ExecState* exec, const Identifier&, const PropertySlot& slot)
{
    if (!static_cast<JSDOMWindow*>(asObject(slot.slotBase()))->allowsAccessFrom(exec))
        return jsUndefined();
    UNUSED_PARAM(exec);
    DOMWindow* imp = static_cast<DOMWindow*>(static_cast<JSDOMWindow*>(asObject(slot.slotBase()))->impl());
    if (JSEventListener* listener = static_cast<JSEventListener*>(imp->ontouchcancel())) {
        if (JSObject* listenerObj = listener->listenerObj())
            return listenerObj;
    }
    return jsNull();
...
JSValuePtr jsDOMWindowTouchEventConstructor(ExecState* exec, const Identifier&, const PropertySlot& slot)
{
    if (!static_cast<JSDOMWindow*>(asObject(slot.slotBase()))->allowsAccessFrom(exec))
        return jsUndefined();
    UNUSED_PARAM(slot);
    return JSTouchEvent::getConstructor(exec);
}
...
void setJSDOMWindowOrientation(ExecState* exec, JSObject* thisObject, JSValuePtr value)
{
    if (!static_cast<JSDOMWindow*>(thisObject)->allowsAccessFrom(exec))
        return;
    static_cast<JSDOMWindow*>(thisObject)->putDirect(Identifier(exec, "orientation"), value);
}
...
void setJSDOMWindowOntouchstart(ExecState* exec, JSObject* thisObject, JSValuePtr value)
{
    if (!static_cast<JSDOMWindow*>(thisObject)->allowsAccessFrom(exec))
        return;
    DOMWindow* imp = static_cast<DOMWindow*>(static_cast<JSDOMWindow*>(thisObject)->impl());
    JSDOMGlobalObject* globalObject = static_cast<JSDOMWindow*>(thisObject);
    imp->setOntouchstart(globalObject->findOrCreateJSEventListener(exec, value, true));
}

void setJSDOMWindowOntouchend(ExecState* exec, JSObject* thisObject, JSValuePtr value)
{
    if (!static_cast<JSDOMWindow*>(thisObject)->allowsAccessFrom(exec))
        return;
    DOMWindow* imp = static_cast<DOMWindow*>(static_cast<JSDOMWindow*>(thisObject)->impl());
    JSDOMGlobalObject* globalObject = static_cast<JSDOMWindow*>(thisObject);
    imp->setOntouchend(globalObject->findOrCreateJSEventListener(exec, value, true));
}

void setJSDOMWindowOntouchmove(ExecState* exec, JSObject* thisObject, JSValuePtr value)
{
    if (!static_cast<JSDOMWindow*>(thisObject)->allowsAccessFrom(exec))
        return;
    DOMWindow* imp = static_cast<DOMWindow*>(static_cast<JSDOMWindow*>(thisObject)->impl());
    JSDOMGlobalObject* globalObject = static_cast<JSDOMWindow*>(thisObject);
    imp->setOntouchmove(globalObject->findOrCreateJSEventListener(exec, value, true));
}

void setJSDOMWindowOntouchcancel(ExecState* exec, JSObject* thisObject, JSValuePtr value)
{
    if (!static_cast<JSDOMWindow*>(thisObject)->allowsAccessFrom(exec))
        return;
    DOMWindow* imp = static_cast<DOMWindow*>(static_cast<JSDOMWindow*>(thisObject)->impl());
    JSDOMGlobalObject* globalObject = static_cast<JSDOMWindow*>(thisObject);
    imp->setOntouchcancel(globalObject->findOrCreateJSEventListener(exec, value, true));
}
...
void setJSDOMWindowTouchEventConstructor(ExecState* exec, JSObject* thisObject, JSValuePtr value)
{
    if (!static_cast<JSDOMWindow*>(thisObject)->allowsAccessFrom(exec))
        return;
    // Shadowing a built-in constructor
